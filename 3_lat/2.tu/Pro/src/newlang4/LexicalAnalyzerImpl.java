...
public class LexicalAnalyzerImpl implements LexicalAnalyzer {
    ...
    private StringBuilder code_s = new StringBuilder();
    private Deque<LexicalUnit> ungetStack = new ArrayDeque<>();
    String code;
    ...
    public LexicalUnit get() throws Exception {
        ...
        map_block.put("SPACE", Pattern.compile("^([ \t]+)"));
        ...
        //Symbol
        sym_map.put(LexicalType.LP, Pattern.compile("^\\("));
        sym_map.put(LexicalType.RP, Pattern.compile("^\\)"));
        ...
        if(!ungetStack.isEmpty()){
            LexicalUnit pop = ungetStack.pop();
        ...
        while(true) {
            for (Map.Entry<String, Pattern> patternEntry : map_block.entrySet()) {
                ...
                if (matcher.find()) {
                    ...
                    } else if (patternEntry.getKey().equals("SPACE")) {
                        continue;
                    }else{
                        break;
                    }
